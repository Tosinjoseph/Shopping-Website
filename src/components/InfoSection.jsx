            ...
            const infoItems = [
                {
                 ...
                 title: 'Free Shipping',
                 description: 'Get your oredrs deliverd with no extra cost'
                },
                {
                ...
                },
                {
                    ...
                    title: 'Discount',
                    description: 'Enjoy the best discount on your product'
                   },
            ];
                ...
                <div className='bg-white pb-8 pt-12'>
                    <div className='container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4'>
                        { infoItems.map((item, i)=>(
                         <div key={i} className='flex flex-col items-center text-center p-4  rounded-lg shadow-md
